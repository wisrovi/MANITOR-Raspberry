...
class Fullscreen_Tkinter:
    ...
    from tkinter import Canvas, StringVar, BooleanVar, Label, IntVar, NW, PhotoImage, CENTER
    ...
    def update_video_instrucion(self, data):
        ...
        self.window.after(18, self.update_video_instrucion, (ind, ind_c))  # Numero que regula la velocidad del gif
