...
GUIONES.append(CreateGuion(id=7, text="ahora frote el dedo pulgar"))
...
GUIONES.append(CreateGuion(id=14, text="Gracias, buen dia"))
GUIONES.append(CreateGuion(id=15, text="Bienvenido"))
